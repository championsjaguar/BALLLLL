...
function reder() {
  if (frameCount % 80 == 0) {
    (redb = createSprite(20, Math.round(random(100, 101)))), 20, 20;
    redb.addImage("r", red);
    redb.scale = 0.1;
    redGroup.add(redb);
    redb.lifetime = 200;
...
function bluer() {
  if (frameCount % 80 == 0) {
    (blueb = createSprite(20, Math.round(random(200, 201)))), 20, 20;
...
function greener() {
  if (frameCount % 80 == 0) {
    (greenb = createSprite(20, Math.round(random(300, 301)))), 20, 20;
...
function pinker() {
  if (frameCount % 80 == 0) {
    (pinkb = createSprite(20, Math.round(random(400, 401)))), 20, 20;
